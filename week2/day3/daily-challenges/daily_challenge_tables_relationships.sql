...
-- LEFT JOIN Customer_profile cp ON c.id = cp.customer_id
-- WHERE cp.isLoggedIn IS FALSE OR cp.isLoggedIn IS NULL;
...
-- -- Delete a student from the Student table, what happened in the junction table ?: the record of John borrowing 'Alice In Wonderland' will be removed from the Library table.
