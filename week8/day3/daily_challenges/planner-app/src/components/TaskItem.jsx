...
function TaskItem({ todo, selectedDay }) {
  ...
  const handleSaveEdit = () => {
    ...
    dispatch(editTask({ day: selectedDay, taskId: todo.id, newText: editedText }));
    setIsEditing(false);
  };
  ...
  const handleDeleteClick = () => {
    if (window.confirm('Are you sure you want to delete this task?')) {
      dispatch(deleteTask({ day: selectedDay, taskId: todo.id }));
    }
  };
